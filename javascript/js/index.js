...
let x = 'this is literaly a string';
...
console.log(arrayofJunk.length);
...
let courses = ["INFO 343", "INFO 481", "CSE 143"];
...
console.log(myCourses[myCourses.length - 1].instructors[0]);
...
function getGreeting(thePlayer) {
    return "Hello " + thePlayer.firstName + " " + thePlayer.lastName + ", you are " +
    "awesome!";
}
...
function levelUp(thePlayer) {
    ...
    thePlayer.level++;
    thePlayer.totalPoints +=
    Math.ceil(thePlayer.totalPoints * (thePlayer.level * 0.1));
    return thePlayer
}
